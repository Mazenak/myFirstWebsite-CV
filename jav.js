function main(){
	...
	$(document).keydown(function(key){
		if (parseInt(key.which,10) === 39 && firstPage === false && countArrow === 4){
			...
			setTimeout(function(){$('body').append('<div class="container"><div class="row"><div id= "last" class=" col-sm-offset-2 col-md-offset-1 col-xs-offset-1 col-md-6 col-sm-8 col-xs-10 text-center"><p>Thanks for enjoying my CV<br><a href="https://mail.google.com/mail/?view=cm&fs=1&to=mazenak94@gmail.com"> E-mail: mazenak94@gmail.com<br><a href="tel:0992355357"> Phone Number: 0992355357</p></div></div></div>')},3000);
		}
	});
	$(document).keydown(function(key){
		if (parseInt(key.which,10) === 39 && firstPage === false && countArrow === 3){
			...
			$('body').append('<div id="fourth-page" class="container"><div class="row"><div class="col-sm-offset-2 col-md-offset-2 col-xs-offset-2 col-md-6 col-sm-8 col-xs-9 text-center"><h1>Work Experince</h1></div></div></div>');
			$('#fourth-page').hide();
			setTimeout(function(){$('#fourth-page').fadeIn('slow')} , 3000);
			setTimeout(function(){$('body').append('<div id = "f1" class="container fourth"><div class="row"><div id="zit" class="col-sm-6 col-md-4 col-xs-6 triangle-isosceles">ZAITOUNY Company for tourism<span class="tooltiptext tooltip-right col-sm-4 col-md-4 col-xs-4"><strong>Registration and customer service employee<br> (6/2014-3/2016)</strong></span></div></div></div>')},5000);
			setTimeout(function(){$('body').append('<div id = "f2" class="container fourth"><div class="row"><div id="taiba" class="col-sm-6 col-md-4 col-xs-6 triangle-isosceles">TAIBA for designing and printing<span class="tooltiptext tooltip-right col-sm-4 col-md-4 col-xs-4"><strong>Print worker and design trainer <br>(6/2010-12/2010)</strong></span></div></div></div>')},5000);
			setTimeout(function(){$('body').append('<div id = "f3" class="container fourth"><div class="row"><div id="twen" class="col-sm-6 col-md-4 col-xs-6 triangle-isosceles">Twenty-Four for Printing Services<span class="tooltiptext tooltip-right col-sm-4 col-md-4 col-xs-4"><strong>Market Manager and Co-designer <br>(12/2016-7/2017)</strong></span></div></div></div>')},5000);
			...
			setTimeout(function(){$('body').append('<div id="next2" class="container"><div  class="row"><div class="col-sm-4 col-md-4 col-xs-6 col-sm-offset-3 col-md-offset-1 col-xs-offset-1 text-center"><p>Hover then Next &rarr;</p></div></div></div>')} , 7000);
			countArrow++;
		}
	});
	$(document).keydown(function(key){
		if (parseInt(key.which,10) === 39 && firstPage === false && countArrow === 2){
			...
			setTimeout(function(){$('body').append('<div id="next2" class="container"><div  class="row"><div class="col-sm-4 col-md-4 col-xs-4 col-sm-offset-3 col-md-offset-1 col-xs-offset-3 text-center"><p>Next &rarr;</p></div></div></div>')} , 6000);
	...
	$(document).keydown(function(key){
		if (parseInt(key.which,10) === 39 && firstPage === false && countArrow === 1){
			...
			setTimeout(function(){$('#second-page').append('<div class="row"><div class="col-md-6 col-sm-9 col-xs-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-0 text-center"><p id="school">Damascus University Faculty of Information Technology Engineering</p></div></div>')},2000);
			setTimeout(function(){$('#school').hide()} , 2000);
			setTimeout(function(){$('#school').fadeIn('slow')} , 2500);
			setTimeout(function(){$('#second-page').append('<div class="row"><div class="col-md-6 col-sm-9 col-xs-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-0  text-center"><p id="special">Bachelor Degree of Information Technology Engineering Department of Artificial Intelligence</p></div></div>')},2500);
			...
			setTimeout(function(){$('body').append('<div id="next2" class="container"><div  class="row"><div class="col-sm-4 col-md-4 col-xs-4 col-sm-offset-4 col-md-offset-1 col-xs-offset-4 text-center"><p>Next &rarr;</p></div></div></div>')} , 6000);
			countArrow++;
...
function makeList(){
	var $list = $('#second-page').append('<div class="row"><div class="col-md-7 col-sm-10 col-xs-9 col-xs-offset-1 col-sm-offset-1 col-md-offset-0 text-center"><ul class="academic"></ul></div></div>').find('ul');
