...
var test = 0;
	$(document).keydown(function(key){
		if (parseInt(key.which,10) === 39){
			...
			setTimeout(function(){$('body').append('<div id="t-page" class="container"><div class="row"><div class="col-xs-offset-2 col-xs-7 col-sm-offset-4 col-md-offset-2  col-md-6 col-sm-6 col-lg-6 col-lg-offset-2 text-center"><h1>Programming Skills</h1></div></div></div>')},18000);
